...
export type FinancialGraphResponse = any;
export type MoneyFlowTraceResponse = any;
export type LaunderingPatternsResponse = any;
export type FinancialCentralityResponse = any;
export type PMLADossierResponse = any;
export type CourtEvidenceCertificateResponse = any;
export type SuspiciousPattern = any;
